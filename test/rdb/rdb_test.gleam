...
pub fn rdb_parse_no_magic_string_test() {
  "test/rdb/hello.txt"
  |> rdb.parse
  |> should.be_error
  |> should.equal(NoMagicString)
}
...
// pub fn rdb_parse_encoded_string_length_prefixed_with_thirty_two_bit_int_test() {
//   let len = 4_294_967_295
//   let content = string.repeat("a", len)

//   <<2:size(2), 0:size(6), len:size(32), content:utf8>>
//   |> rdb.parse_encoded_string
//   |> should.be_ok
//   |> should.equal(#(<<content:utf8>>, <<>>))
// }
